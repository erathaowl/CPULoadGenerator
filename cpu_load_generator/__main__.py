...
def parse_args(parser):
    ...
    parser.add_argument('-d', '--duration', type=int, help='Duration of the load in seconds. Should be 0 for infinite loop or higher than 0.')
    parser.add_argument('-c', '--cpu_core', type=int, default=-1,
...
def input_error_handler(args):
    ...
    if args.path_to_profile_json == "":
        ...
        if args.duration < 0:
            raise ValueError('The load duration must be 0 or higher value')
